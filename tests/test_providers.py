...
class TestAodLLMProviders(unittest.TestCase):
    ...
    def test_create_openrouter_provider_uses_claude_sonnet_defaults(self):
        provider = create_provider(
            'openrouter',
        ...
        self.assertEqual('anthropic/claude-sonnet-5', provider.model)
        self.assertEqual(
    ...
    def test_openrouter_request_uses_default_model_and_headers(self):
        ...
        self.assertEqual('anthropic/claude-sonnet-5', payload['model'])
